...
class DataBindingIdlingResource: IdlingResource {
    ...
    lateinit var dataBindingActivity: FragmentActivity
    ...
    override fun isIdleNow(): Boolean {
        ...
        if (idle) {
            ...
            wasNotIdle = true
            // Check next frame.
            dataBindingActivity.findViewById<View>(android.R.id.content).postDelayed({
                isIdleNow
            }, 16)
        }
        return idle
    ...
    private fun getBindings(): List<ViewDataBinding> {
        val fragments = (dataBindingActivity as? FragmentActivity)
